...
Add-Content -Path $File  "      - name: catalog" 
Add-Content -Path $File  "        image: $imageTag$AzureContainerRegistryName/$catalogImage" 
...
Add-Content -Path $File  "      containers:" 
Add-Content -Path $File  "      - name: basket" 
Add-Content -Path $File  "        image: $imageTag$AzureContainerRegistryName/$basketImage"
Add-Content -Path $File  "        env:" 
Add-Content -Path $File  "        - name: GET_HOSTS_FROM" 
Add-Content -Path $File  "          value: dns" 
...
Add-Content -Path $File  "      containers:" 
Add-Content -Path $File  "      - name: gateway" 
Add-Content -Path $File  "        image: $imageTag$AzureContainerRegistryName/$gatewayImage"
Add-Content -Path $File  "        env:" 
Add-Content -Path $File  "        - name: GET_HOSTS_FROM" 
Add-Content -Path $File  "          value: dns" 
Add-Content -Path $File  "        - name: Catalog" 
...
Add-Content -Path $File  "      containers:" 
Add-Content -Path $File  "      - name: ordering" 
Add-Content -Path $File  "        image: $imageTag$AzureContainerRegistryName/$orderingImage"
Add-Content -Path $File  "        env:" 
Add-Content -Path $File  "        - name: GET_HOSTS_FROM" 
Add-Content -Path $File  "          value: dns" 
...
Add-Content -Path $File  "      containers:" 
Add-Content -Path $File  "      - name: ui" 
Add-Content -Path $File  "        image: $imageTag$AzureContainerRegistryName/$uiImage"
Add-Content -Path $File  "        env:" 
Add-Content -Path $File  "        - name: GET_HOSTS_FROM" 
Add-Content -Path $File  "          value: dns" 
