...
//        /// <param name="basketId">Id of shopping basket</param>
//        /// <returns>BasketItemEntity</returns>
//        public async Task<BasketEntity> AddItemToBasket(int productId, Guid productGuidId, string correlationToken, string basketId)
//        {
...
//                readEntity = await _distributedCacheRepository.GetBasketAsync(productId.ToString(), correlationToken, _telemetryClient);
//            }
//            catch (Exception ex)
//            {
//                _logger.LogError(ex.Message,
//                "Exception throw in AddItemToBasket() in BasketBusinessServices reading cache for entity: {message}", ex.Message);

//                throw new Exception($"Error in AddItemToBasket() in BasketBusinessServices reading cache for entity: {ex.Message}");
//            }

//            // Fallback logic if product not found in local read store
...
//                await _distributedCacheRepository.UpdateBasketAsync(productReadModel, correlationToken, _telemetryClient);
...
//            orderInformationModel.CheckoutId = TokenGenerator.GenerateId(TokenGeneratorEnum.Checkout);
